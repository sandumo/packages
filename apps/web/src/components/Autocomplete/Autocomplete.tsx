...
import { VariableSizeList, ListChildComponentProps, ReactElementType } from 'react-window';
    ...
    <div ref={ref}>
      <OuterElementContext.Provider value={other}>
        <VariableSizeList
          ...
          width="100%"
          ref={gridRef}
          outerElementType={OuterElementType as ReactElementType}
          innerElementType="ul"
          itemSize={(index) => getChildSize(itemData[index])}
          overscanCount={5}
          itemCount={itemCount}
        >
          {(props) => renderRow(props as unknown as ListChildComponentProps) as any}
        </VariableSizeList>
